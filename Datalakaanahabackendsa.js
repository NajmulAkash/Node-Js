...
const Server = http.createServer((req, res)=>{
    ...
    res.write('<html>')
    res.write('<head><title>Node JS</title><style>#center{color: red;display: block;text-align: center;margin-left: 50px;}</style></head>')
    res.write('<body><h1>Wellcome</h1></body>')
    res.write('<form>')
    res.write('<input type="text" name="Username" placeholder="Enter your Details">')
      res.write('<input id="center" type="text" name="UserEmail" placeholder="Enter your Details">')
